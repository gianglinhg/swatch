...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th6 12, 2023 lúc 10:03 AM
...
CREATE TABLE `orders` (
  ...
  `payment` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'COD',
...
CREATE TABLE `page_meta` (
  ...
  `meta_label` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  `meta_type` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `users` (
  ...
  `avatar` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'images/ava_default.png',
  `phone` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL,
